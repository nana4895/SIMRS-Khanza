...
public final class RMPenilaianAwalKeperawatanIGD extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Lapor1 = new widget.ComboBox();
        TindakLanjut = new widget.ComboBox();
        jLabel27 = new widget.Label();
        Ket_Tindak_Lanjut = new widget.TextBox();
        ...
        Dipulangkan = new widget.TextBox();
        ...
        KetLapor.setBounds(780, 980, 80, 23);
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "17-04-2024 13:12:44" }));
        ...
        jLabel71.setText("GCS(E,V,M) :");
        jLabel71.setName("jLabel71"); // NOI18N
        FormInput.add(jLabel71);
        jLabel71.setBounds(400, 1310, 70, 23);
        ...
        jSeparator10.setBounds(0, 1008, 880, 3);
        ...
        jSeparator2.setBounds(0, 1250, 880, 3);

        jLabel69.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel69.setText("VII. TINDAK LANJUT");
        jLabel69.setName("jLabel69"); // NOI18N
        FormInput.add(jLabel69);
        jLabel69.setBounds(10, 1200, 380, 23);
        ...
        jSeparator3.setBounds(0, 1197, 880, 3);

        Tindakan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Preventif", "Kuratif", "Rehabilitatif", "Promotif" }));
        ...
        Tindakan.setBounds(90, 1220, 130, 23);

        jLabel73.setText("Jam dilaporkan :");
        jLabel73.setName("jLabel73"); // NOI18N
        FormInput.add(jLabel73);
        jLabel73.setBounds(680, 980, 90, 23);
        ...
        FormInput.add(TD);
        TD.setBounds(50, 1310, 50, 23);

        jLabel23.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel23.setText("mmHg");
        jLabel23.setName("jLabel23"); // NOI18N
        FormInput.add(jLabel23);
        jLabel23.setBounds(110, 1310, 40, 23);

        jLabel17.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel17.setText("Tindakan :");
        jLabel17.setName("jLabel17"); // NOI18N
        FormInput.add(jLabel17);
        jLabel17.setBounds(30, 1220, 60, 23);
        ...
        FormInput.add(Nadi);
        Nadi.setBounds(50, 1280, 50, 23);

        jLabel16.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel16.setText("x/menit");
        jLabel16.setName("jLabel16"); // NOI18N
        FormInput.add(jLabel16);
        jLabel16.setBounds(110, 1280, 40, 23);

        jLabel26.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel26.setText("RR :");
        jLabel26.setName("jLabel26"); // NOI18N
        FormInput.add(jLabel26);
        jLabel26.setBounds(160, 1310, 30, 23);
        ...
        FormInput.add(RR);
        RR.setBounds(190, 1310, 45, 23);

        jLabel25.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel25.setText("x/menit");
        jLabel25.setName("jLabel25"); // NOI18N
        FormInput.add(jLabel25);
        jLabel25.setBounds(240, 1310, 50, 23);

        jLabel18.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel18.setText("Suhu :");
        jLabel18.setName("jLabel18"); // NOI18N
        FormInput.add(jLabel18);
        jLabel18.setBounds(160, 1280, 40, 23);
        ...
        FormInput.add(Suhu);
        Suhu.setBounds(200, 1280, 45, 23);

        jLabel15.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel15.setText("TB :");
        jLabel15.setName("jLabel15"); // NOI18N
        FormInput.add(jLabel15);
        jLabel15.setBounds(280, 1280, 30, 23);
        ...
        FormInput.add(TB);
        TB.setBounds(310, 1280, 45, 23);

        jLabel20.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel20.setText("°C");
        jLabel20.setName("jLabel20"); // NOI18N
        FormInput.add(jLabel20);
        jLabel20.setBounds(250, 1280, 30, 23);

        jLabel24.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel24.setText(" cm");
        jLabel24.setName("jLabel24"); // NOI18N
        FormInput.add(jLabel24);
        jLabel24.setBounds(360, 1280, 30, 23);

        jLabel12.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel12.setText("Meninggal Pukul : ");
        jLabel12.setName("jLabel12"); // NOI18N
        FormInput.add(jLabel12);
        jLabel12.setBounds(630, 1370, 100, 23);

        jLabel40.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel40.setText("SpO2 :");
        jLabel40.setName("jLabel40"); // NOI18N
        FormInput.add(jLabel40);
        jLabel40.setBounds(290, 1310, 40, 23);
        ...
        FormInput.add(BB);
        BB.setBounds(430, 1280, 45, 23);

        jLabel13.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel13.setText("Kg");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(480, 1280, 30, 23);

        jLabel41.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel41.setText("%");
        jLabel41.setName("jLabel41"); // NOI18N
        FormInput.add(jLabel41);
        jLabel41.setBounds(380, 1310, 30, 23);

        Lapor1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya" }));
        Lapor1.setName("Lapor1"); // NOI18N
        Lapor1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                Lapor1KeyPressed(evt);
            }
        });
        FormInput.add(Lapor1);
        Lapor1.setBounds(575, 980, 80, 23);

        TindakLanjut.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "APS", "Dirujuk", "Operasi", "Kamar Bersalin", "Rawat Inap", "Melarikan Diri" }));
        ...
        TindakLanjut.setBounds(100, 1340, 130, 23);

        jLabel27.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel27.setText("TD :");
        jLabel27.setName("jLabel27"); // NOI18N
        FormInput.add(jLabel27);
        jLabel27.setBounds(20, 1310, 40, 23);

        Ket_Tindak_Lanjut.setFocusTraversalPolicyProvider(true);
        Ket_Tindak_Lanjut.setName("Ket_Tindak_Lanjut"); // NOI18N
        Ket_Tindak_Lanjut.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                Ket_Tindak_LanjutKeyPressed(evt);
            }
        });
        FormInput.add(Ket_Tindak_Lanjut);
        Ket_Tindak_Lanjut.setBounds(240, 1340, 160, 23);

        jLabel28.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel28.setText("Tindak Lanjut :");
        jLabel28.setName("jLabel28"); // NOI18N
        FormInput.add(jLabel28);
        jLabel28.setBounds(20, 1340, 80, 23);

        Transportasi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Kendaraan Pribadi", "Ambulance", "Mobil Jenazah" }));
        ...
        Transportasi.setBounds(100, 1370, 130, 23);

        jLabel42.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel42.setText("Transportasi :");
        ...
        jLabel74.setBounds(10, 1260, 380, 23);

        jLabel43.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel43.setText("Nadi :");
        jLabel43.setName("jLabel43"); // NOI18N
        FormInput.add(jLabel43);
        jLabel43.setBounds(20, 1280, 40, 23);

        jLabel14.setText("BB :");
        jLabel14.setName("jLabel14"); // NOI18N
        FormInput.add(jLabel14);
        jLabel14.setBounds(390, 1280, 30, 23);

        Dipulangkan.setFocusTraversalPolicyProvider(true);
        ...
        Dipulangkan.setBounds(530, 1370, 80, 23);

        jLabel44.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel44.setText("Masuk di Ruang : ");
        jLabel44.setName("jLabel44"); // NOI18N
        FormInput.add(jLabel44);
        jLabel44.setBounds(430, 1340, 100, 23);
        ...
        Meninggal.setBounds(730, 1370, 80, 23);

        jLabel45.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel45.setText("Dipulangkan Pukul : ");
        jLabel45.setName("jLabel45"); // NOI18N
        FormInput.add(jLabel45);
        jLabel45.setBounds(430, 1370, 100, 23);

        MasukRuang.setFocusTraversalPolicyProvider(true);
        MasukRuang.setName("MasukRuang"); // NOI18N
        MasukRuang.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                MasukRuangKeyPressed(evt);
            }
        });
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TNoRM.getText().trim().equals("")) {
            ...
            if (Sequel.menyimpantf("penilaian_awal_keperawatan_igd", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "No.Rawat", 85, new String[]{
        ...
        if (TNoRM.getText().trim().equals("")) {
            ...
            if (tbObat.getSelectedRow() > -1) {
                if (akses.getkode().equals("Admin Utama")) {
                    ...
                    if (KdPetugas.getText().equals(tbObat.getValueAt(tbObat.getSelectedRow(), 95).toString())) {
                        ganti();
                    } else {
    ...
    private void TBKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TBKeyPressed
        Valid.pindah(evt, TB, BB);
    }//GEN-LAST:event_TBKeyPressed

    private void Lapor1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Lapor1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_Lapor1KeyPressed

    private void TindakLanjutKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TindakLanjutKeyPressed
        Valid.pindah(evt, TindakLanjut, Ket_Tindak_Lanjut);
    }//GEN-LAST:event_TindakLanjutKeyPressed

    private void Ket_Tindak_LanjutKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Ket_Tindak_LanjutKeyPressed
        Valid.pindah(evt, Ket_Tindak_Lanjut, MasukRuang);
    }//GEN-LAST:event_Ket_Tindak_LanjutKeyPressed
    ...
    private void DipulangkanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_DipulangkanKeyPressed
        Valid.pindah(evt, Dipulangkan, Meninggal);
    ...
    private void MasukRuangKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_MasukRuangKeyPressed
        Valid.pindah(evt, MasukRuang, Transportasi);
    }//GEN-LAST:event_MasukRuangKeyPressed
    ...
    private void SPOKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_SPOKeyPressed
        Valid.pindah(evt, SPO, GCS);
    }//GEN-LAST:event_SPOKeyPressed

    private void GCSKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_GCSKeyPressed
        Valid.pindah(evt, GCS, TindakLanjut);
    ...
    private widget.TextBox Dipulangkan;
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            Tindakan.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 79).toString());
            Nadi.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 80).toString());
            Suhu.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 81).toString());
            TB.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 82).toString());
            BB.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 83).toString());
            TD.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 84).toString());
            RR.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 85).toString());
            SPO.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 86).toString());
            GCS.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 87).toString());
            TindakLanjut.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 88).toString());
            Ket_Tindak_Lanjut.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 89).toString());
            MasukRuang.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 90).toString());
